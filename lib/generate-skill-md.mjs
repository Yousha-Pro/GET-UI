...
## Coding Architecture
This design system uses a **${architecture}** architecture. AI agents must follow this naming convention and structural pattern for all generated code.
